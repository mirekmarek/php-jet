...
use Jet\DataModel_Definition_Property_String;

use Jet\Form_Field;
use Jet\Form_Field_Input;
use Jet\Form_Field_Int;

class DataModels_Property_String extends DataModel_Definition_Property_String implements DataModels_Property_Interface {
