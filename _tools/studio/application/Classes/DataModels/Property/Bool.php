...
use Jet\DataModel_Definition_Property_Bool;

use Jet\Form_Field;

class DataModels_Property_Bool extends DataModel_Definition_Property_Bool implements DataModels_Property_Interface {
