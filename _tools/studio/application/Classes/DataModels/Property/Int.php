...
use Jet\DataModel_Definition_Property_Int;

use Jet\Form_Field;
use Jet\Form_Field_Int;

class DataModels_Property_Int extends DataModel_Definition_Property_Int implements DataModels_Property_Interface {
