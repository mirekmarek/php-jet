...
use Jet\DataModel_Definition_Property_Date;

use Jet\Form_Field;

class DataModels_Property_Date extends DataModel_Definition_Property_Date implements DataModels_Property_Interface {
	...
	public function createClassProperty( ClassCreator_Class $class )
	{
		...
		$property = $this->createClassProperty_main( $class, 'Data_DateTime',  'DataModel::TYPE_DATE', $annotations);
