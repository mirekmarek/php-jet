...
const JQUERY_UI_JS_URL = '//code.jquery.com/ui/1.11.4/jquery-ui.js';
const JQUERY_UI_CSS_URL = '//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css';
...
define('JET_AJAX_FORM_JS_URL', SysConf_URI::PUBLIC().'js/JetAjaxForm.js?v=1');
define('JET_MULTI_UPLOADER_JS_URL', SysConf_URI::PUBLIC().'js/JetMultiUploader.js?v=1');
