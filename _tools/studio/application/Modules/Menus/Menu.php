 ...
 *
 */
class Menu extends Navigation_Menu
{
	...
	public static function getCreateForm(): Form
	{
		if( !static::$create_form ) {
			...
			$form->setAction( Main::getActionUrl( 'menu_add' ) );
	 ...
	 * @return bool|Menu
	 */
	public static function catchCreateForm(): bool|Menu
	{
	...
	public function getEditForm(): Form
	{
		if( !$this->__edit_form ) {
			...
			$form->setAction( Main::getActionUrl( 'menu_edit' ) );
	 ...
	 */
	public function getItem( string $id ): Menu_Item|null
	{
