...
use JetStudio\JetStudio_Module_Service_Validators;

class Main extends JetStudio_Module implements JetStudio_Module_Service_Validators
{
	protected static ValidatorClass|null|bool $current_class = null;
	protected static ValidatorClass_Property|bool|null $current_property = null;
	...
	public static function getActionUrl( string $action ): string
	{
		...
		return JetStudio::getModuleManifest('Validators')->getURL() . '?' . http_build_query( $get_params );
	}
	...
	public static function getClass( string $name ): ValidatorClass|null
	{
		static::load();
	...
	public static function getCurrentClass(): ValidatorClass|null|bool
	{
	...
	public static function getCurrentProperty() : ValidatorClass_Property|null
	{
