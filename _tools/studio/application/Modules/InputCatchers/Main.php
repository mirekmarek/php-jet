...
use JetStudio\JetStudio_Module_Service_InputCatchers;

class Main extends JetStudio_Module implements JetStudio_Module_Service_InputCatchers
{
	protected static InputCatcherClass|null|bool $current_class = null;
	protected static InputCatcherClass_Property|bool|null $current_property = null;
	
	/**
	 * @var InputCatcherClass[]
	 */
	...
	public static function getActionUrl( string $action ): string
	{
		...
		return JetStudio::getModuleManifest('InputCatchers')->getURL() . '?' . http_build_query( $get_params );
	}
	...
	public static function getClass( string $name ): InputCatcherClass|null
	{
		static::load();
	...
	public static function getCurrentClass(): InputCatcherClass|null|bool
	{
	...
	public static function getCurrentProperty() : InputCatcherClass_Property|null
	{
