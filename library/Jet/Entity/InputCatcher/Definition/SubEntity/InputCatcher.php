 ...
 *
 */
class Entity_InputCatcher_Definition_SubEntity_InputCatcher extends Entity_InputCatcher_Definition
{
	protected false|string $type = 'sub_catcher';
	protected bool $is_sub_input_catcher = true;
