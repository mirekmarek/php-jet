...
class Memcache_Factory extends Factory {
	 ...
	 * @var string
	 */
	protected static $connection_class_prefix = 'Memcache_Connection_';
	 ...
	 */
	public static function getConnectionConfigInstance(array $config_data= [], Memcache_Config $config=null ){
