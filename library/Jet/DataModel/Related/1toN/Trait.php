...
trait DataModel_Related_1toN_Trait {
	...
	public static function getLoadRelatedDataOrderBy()
	{
		...
		return static::$load_related_data_order_by ?
			static::$load_related_data_order_by : $definition->getDefaultOrderBy();
	}
	 ...
	 */
	protected static function getLoadRelatedDataQuery(DataModel_Id_Abstract $main_id, DataModel_PropertyFilter $load_filter=null )
	{
