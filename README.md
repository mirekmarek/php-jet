...
PHP Jet is a powerful **PHP8** framework. Of course, it includes **modularity / microservices / micro-app architecture**, **MVC architecture**, **ORM (MySQL/MariaDB, SQLite, PostgreSQL and MS SQL support, Oracle support development int progress)**, **REST API server** and so on, but above all, it offers **incredible performance, flexibility and freedom**.
