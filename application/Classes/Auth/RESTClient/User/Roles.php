...
#[DataModel_Definition(database_table_name: 'users_rest_clients_roles')]
#[DataModel_Definition(parent_model_class: Auth_RESTClient_User::class)]
#[DataModel_Definition(N_model_class: Auth_RESTClient_Role::class)]
