...
class DataModel_Query_DataModelTestMock extends DataModel {
	...
	protected static $__data_model_properties_definition = array(
		...
		"data_model_property_1toN" => array(
			"type" => self::TYPE_DATA_MODEL,
			"data_model_class" => "Jet\\DataModel_Query_DataModelRelated1TONTestMock",

		),
		"data_model_property_1to1" => array(
			"type" => self::TYPE_DATA_MODEL,
			"data_model_class" => "Jet\\DataModel_Query_DataModelRelated1TO1TestMock",

		),
		"data_model_property_MtoN" => array(
			"type" => self::TYPE_DATA_MODEL,
			"data_model_class" => "Jet\\DataModel_Query_DataModelRelatedMTONTestMock",
