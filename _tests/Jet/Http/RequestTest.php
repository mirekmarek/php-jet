...
class Http_RequestTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testPOST()
	{
		...
		$this->assertEquals(
			pi(), Http_Request::POST()->getFloat( 'float' )
		);
		$this->assertEquals(
			123, Http_Request::POST()->getFloat( 'int' )
		);
	...
	public function testGET()
	{
		...
		$this->assertEquals(
			pi(), Http_Request::GET()->getFloat( 'float' )
		);
		$this->assertEquals(
			123, Http_Request::GET()->getFloat( 'int' )
		);
	...
	public function testSERVER()
	{
		...
		$this->assertEquals(
			pi(), Http_Request::SERVER()->getFloat( 'float' )
		);
		$this->assertEquals(
			123, Http_Request::SERVER()->getFloat( 'int' )
		);
	...
	{
		$headers = [
			'Header-1' => 'Header 1 value', 'Header-2' => 'Header 2 value', 'Header-3' => 'Header 3 value',
		];
