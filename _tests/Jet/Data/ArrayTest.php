...
class Data_ArrayTest extends \PHPUnit_Framework_TestCase
{
	...
	protected $data = [
		'int' => 1, 'float' => 3.14, 'string' => '<script>alert("Shady!");</script>', 'bool' => true, 'sub1' => [
			'int' => 2, 'float' => 6.28, 'string' => '<script>alert("Shady!!");</script>', 'bool' => false,

			'sub2'      => [
				'int' => 4, 'float' => 12.56, 'string' => '<script>alert("Shady!!!");</script>', 'bool' => true,
	...
	protected $comments = [
		'/int'                   => '/int comment', '/float' => '/float comment', '/string' => '/string comment',
		'/sub1'                  => '/sub1 comment', '/sub1/int' => '/sub1/int comment',
		'/sub1/float'            => '/sub1/float comment', '/sub1/string' => '/sub1/string comment',
		'/sub1/sub2'             => '/sub1/sub2 comment', '/sub1/sub2/int' => '/sub1/sub2/int comment',
		'/sub1/sub2/float'       => '/sub1/sub2/float comment', '/sub1/sub2/string' => '/sub1/sub2/string comment',
	...
	public function testAppendData()
	{
		...
		$this->assertEquals(
			array_merge( $this->data, $new_data ), $this->object->getRawData()
		);
	}
	...
	public function testSetData()
	{
		...
		$this->assertEquals(
			$new_data, $this->object->getRawData()
		);
	}
	...
	{
		$this->assertEquals(
			Data_Text::htmlSpecialChars( $this->data['string'] ), $this->object->getString( 'string' )
		);
		$this->assertEquals(
			Data_Text::htmlSpecialChars( $this->data['string'] ), $this->object->getString( '/string' )
		);
		$this->assertEquals(
			Data_Text::htmlSpecialChars( $this->data['sub1']['sub2']['string'] ),
			$this->object->getString( '/sub1/sub2/string' )
		);
	}
	...
	{
		$valid_result = '['.JET_EOL.JET_TAB.'\'int\' => 1'.JET_TAB.'/* /int comment */,'.JET_EOL.JET_TAB.'\'float\' => 3.14'.JET_TAB.'/* /float comment */,'.JET_EOL.JET_TAB.'\'string\' => \'<script>alert("Shady!");</script>\''.JET_TAB.'/* /string comment */,'.JET_EOL.JET_TAB.'\'bool\' => true,'.JET_EOL.JET_TAB.'\'sub1\' => ['.JET_TAB.'/* /sub1 comment */'.JET_EOL.JET_TAB.JET_TAB.'\'int\' => 2'.JET_TAB.'/* /sub1/int comment */,'.JET_EOL.JET_TAB.JET_TAB.'\'float\' => 6.28'.JET_TAB.'/* /sub1/float comment */,'.JET_EOL.JET_TAB.JET_TAB.'\'string\' => \'<script>alert("Shady!!");</script>\''.JET_TAB.'/* /sub1/string comment */,'.JET_EOL.JET_TAB.JET_TAB.'\'bool\' => false,'.JET_EOL.JET_TAB.JET_TAB.'\'sub2\' => ['.JET_TAB.'/* /sub1/sub2 comment */'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'int\' => 4'.JET_TAB.'/* /sub1/sub2/int comment */,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'float\' => 12.56'.JET_TAB.'/* /sub1/sub2/float comment */,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'string\' => \'<script>alert("Shady!!!");</script>\''.JET_TAB.'/* /sub1/sub2/string comment */,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'bool\' => true,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'test_object\' => Jet\Data_ArrayTest_testObject::__set_state( ['.JET_TAB.'/* /sub1/sub2/test_object comment */'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_int\' => 1,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_float\' => 3.14,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_string\' => \'<script>alert("Shady!");</script>\','.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'] ),'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'test_object2\' => Jet\Data_ArrayTest_testObject2::__set_state( ['.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_int\' => 1,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'] ),'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'test_object3\' => Jet\Data_ArrayTest_testObject3::__set_state( ['.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_int\' => 1,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_float\' => 3.14,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.JET_TAB.'\'v_string\' => \'<script>alert("Shady!");</script>\','.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'] ),'.JET_EOL.JET_TAB.JET_TAB.'],'.JET_EOL.JET_TAB.JET_TAB.'\'sub_ai\' => ['.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'1,'.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'\'string\','.JET_EOL.JET_TAB.JET_TAB.JET_TAB.'123.456,'.JET_EOL.JET_TAB.JET_TAB.'],'.JET_EOL.JET_TAB.'],'.JET_EOL.'];'.JET_EOL;
