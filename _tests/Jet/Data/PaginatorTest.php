...
class Data_PaginatorTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testSetData()
	{
		...
		$this->assertEquals(
			[
				0 => 'Item 0', 1 => 'Item 1', 2 => 'Item 2', 3 => 'Item 3', 4 => 'Item 4', 5 => 'Item 5', 6 => 'Item 6',
		...
		$this->assertEquals(
			[
				40 => 'Item 40', 41 => 'Item 41', 42 => 'Item 42', 43 => 'Item 43', 44 => 'Item 44', 45 => 'Item 45',
				46 => 'Item 46', 47 => 'Item 47', 48 => 'Item 48', 49 => 'Item 49',
			], $this->object->getData()
		);
		...
		$this->assertEquals(
			[
				120 => 'Item 120', 121 => 'Item 121', 122 => 'Item 122',
			], $this->object->getData()
		);
		$this->assertFalse( $this->object->getCurrentPageNoIsInRange() );
		...
		$this->assertEquals(
			[
				1 => 'test:1', 2 => 'test:2', 3 => 'test:3', 4 => 'test:4', 5 => 'test:5', 6 => 'test:6', 7 => 'test:7',
				8 => 'test:8', 9 => 'test:9', 10 => 'test:10', 11 => 'test:11', 12 => 'test:12', 13 => 'test:13',
