...
class DataModel_Definition_Model_MainTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testGetProperties()
	{
		...
		$property_names = [
			'id', 'id_property', 'string_property', 'locale_property', 'int_property', 'float_property',
			'bool_property', 'array_property', 'date_time_property', 'date_property', 'data_model_property',
		];
