...
class DataModel_Query_OrderBy_ItemTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->select_string_item = new DataModel_Query_Select_Item(
			$this->properties['string_property'], 'string_property_test'
		);
		$this->select_int_item = new DataModel_Query_Select_Item(
			$this->properties['int_property'], 'int_property_test'
		);
