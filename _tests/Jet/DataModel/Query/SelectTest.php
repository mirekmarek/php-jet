...
class DataModel_Query_SelectTest extends \PHPUnit_Framework_TestCase
{
	...
	public function test__constructFailed1()
	{
		...
		$this->object = new DataModel_Query_Select(
			$query, [
				      'some' => 'crap',
			      ]
		);
	...
	{
		$this->assertTrue(
			$this->object->getItem( 'id_property' )->getItem() instanceof DataModel_Definition_Property_Abstract
		);
		$this->assertTrue(
			$this->object->getItem( 'my_string_property' )->getItem() instanceof DataModel_Definition_Property_Abstract
		);
		$this->assertTrue(
			$this->object->getItem( 'my_count' )->getItem() instanceof DataModel_Query_Select_Item_BackendFunctionCall
		);
		$this->assertTrue(
			$this->object->getItem( 'my_sum' )->getItem() instanceof DataModel_Query_Select_Item_BackendFunctionCall
		);
	}
