...
class DataModel_QueryTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testRelationsMtoN()
	{
		...
		$this->assertEquals(
			[
				'data_model_test_mock_related_MtoN', 'data_model_2_test_mock',
			], array_keys( $this->object->getRelations() )
		);


		$this->assertEquals(
			DataModel_Query::JOIN_TYPE_LEFT_JOIN, $this->object->getRelation( 'data_model_2_test_mock' )->getJoinType()
		);

		$this->object->getRelation( 'data_model_2_test_mock' )->setJoinType(
	...
	public function testRelations1toN()
	{
		...
		$this->object->getRelation( 'data_model_test_mock_related_1toN' )->setJoinType(
			DataModel_Query::JOIN_TYPE_LEFT_OUTER_JOIN
		);
	...
	public function testRelations1to1()
	{
		...
		$this->object->getRelation( 'data_model_test_mock_related_1to1' )->setJoinType(
			DataModel_Query::JOIN_TYPE_LEFT_OUTER_JOIN
		);
	...
	protected function setUp()
	{
		...
		$this->having_data = [
			'int_property =' => 1234, 'AND', 'string_property !=' => 'test', 'OR', [
