...
class IO_FileTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertEquals(
			'application/msword-test', IO_File::getMimeType(
			IO_FILE_TEST_BASEDIR.'mime/doc.docx', IO_FILE_TEST_BASEDIR.'mime/map.php'
		)
		);
		$this->assertEquals(
			'application/msexcel-test', IO_File::getMimeType(
			IO_FILE_TEST_BASEDIR.'mime/sheet.xlsx', IO_FILE_TEST_BASEDIR.'mime/map.php'
		)
		);
		$this->assertEquals( 'application/msword', IO_File::getMimeType( IO_FILE_TEST_BASEDIR.'mime/doc.doc' ) );
		$this->assertEquals(
			'application/vnd.ms-excel', IO_File::getMimeType( IO_FILE_TEST_BASEDIR.'mime/sheet.xls' )
		);
