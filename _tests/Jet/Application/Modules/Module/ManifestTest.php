...
if( !defined( 'JET_MODULES_PATH' ) ) define( 'JET_MODULES_PATH', JET_TESTS_DATA.'Application/Modules/TestModules/' );
...
class Application_Modules_Module_ManifestTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$data = [
			'MyType1' => 'MyModuleType1', 'MyType2' => 'MyModuleType2', 'MyType3' => 'MyModuleType3',
		];
