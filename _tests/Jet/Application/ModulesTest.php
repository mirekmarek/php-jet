...
class Application_ModulesTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testCheckModuleNameFormat()
	{
		...
		$this->assertFalse(
			$this->object->checkModuleNameFormat( 'LongLongLongLongLongLongLongLongLongLongLongLongLon' )
		);
	...
	{
		$valid_data = [
			'Vendor.Package.TestModule'     => Application_Modules_Module_Manifest::__set_state(
				[
					'name'        => 'Vendor.Package.TestModule', 'vendor' => 'Vendor', 'label' => 'Test Module 1',
					'description' => 'Test module 1...', 'API_version' => 201401, 'types' => [
					0 => 'general',
				], 'require'      => [], 'module_dir' => '', 'is_installed' => false, 'is_activated' => false,
				]
			), 'Vendor.Package.TestModule2' => Application_Modules_Module_Manifest::__set_state(
				[
					'name'        => 'Vendor.Package.TestModule2', 'vendor' => 'Vendor', 'label' => 'Test Module 2',
					'description' => 'Test module 2...', 'API_version' => 201401, 'types' => [
					0 => 'general',
				], 'require'      => [
					0 => 'Vendor.Package.TestModule',
				], 'module_dir'   => '', 'is_installed' => false, 'is_activated' => false,
				]
			), 'ValidModule'                => Application_Modules_Module_Manifest::__set_state(
				[
					'name'        => 'ValidModule', 'label' => 'Test Module', 'description' => 'Unit test module',
					'API_version' => 201401, 'types' => [
					0 => 'general',
				], 'require'      => [
					0 => 'RequireModule1', 1 => 'RequireModule2',
				], 'module_dir'   => '', 'is_installed' => false, 'is_activated' => false,
				]
			),
		];
		...
		$valid_data = [
			'Vendor.Package.TestModule'     => Application_Modules_Module_Manifest::__set_state(
				[
					...
					'description' => 'Test module 1...', 'API_version' => 201401, 'types' => [
					0 => 'general',
				], 'require'      => [], 'module_dir' => '', 'is_installed' => true, 'is_activated' => false,
				]
			), 'Vendor.Package.TestModule2' => Application_Modules_Module_Manifest::__set_state(
				[
					'name'        => 'Vendor.Package.TestModule2', 'vendor' => 'Vendor', 'label' => 'Test Module 2',
					...
					0 => 'Vendor.Package.TestModule',
				], 'module_dir'   => '', 'is_installed' => true, 'is_activated' => false,
				]
			),
		];
		...
		$valid_data = [
			'Vendor.Package.TestModule'     => Application_Modules_Module_Manifest::__set_state(
				[
					...
					'description' => 'Test module 1...', 'API_version' => 201401, 'types' => [
					0 => 'general',
				], 'require'      => [], 'module_dir' => '', 'is_installed' => true, 'is_activated' => true,
				]
			), 'Vendor.Package.TestModule2' => Application_Modules_Module_Manifest::__set_state(
				[
					'name'        => 'Vendor.Package.TestModule2', 'vendor' => 'Vendor', 'label' => 'Test Module 2',
					...
					0 => 'Vendor.Package.TestModule',
				], 'module_dir'   => '', 'is_installed' => true, 'is_activated' => true,
				]
			),
		];
	...
	protected function setUp()
	{
		$this->object = new Application_Modules_Handler(
			JET_TESTS_DATA.'Application/Modules/TestModules/', JET_TESTS_TMP.'modules_list.php', 'JetApplicationModule',
